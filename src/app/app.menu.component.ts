        ...
        this.model = [
...

            {
                ...
                items: [
                    ...
                    {label: 'Rapport De Présence', icon: 'pi pi-fw  pi pi-file', routerLink: ['gestion/ListPointageByService'], roles: this.findRole(['ROLE_CHEFDESERVICE','ROLE_DRH'])},

                    // {label: 'Absences Journalières', icon: 'pi pi-fw pi-id-card', routerLink: ['/gestion/absencejournaliere'], roles: this.findRole(['ROLE_DRH'],)},
                    {label: 'Liste Présence du service', icon: 'pi pi-fw pi pi-list', routerLink: ['/gestion/superviseur'], roles: this.findRole(['ROLE_DRH','ROLE_CHEFDESERVICE'])},
            ...
            },
            {
              ...
              //      {label: 'form', icon: 'pi pi-fw pi-id-card', routerLink: ['/gestion/test'], roles: this.findRole(['ROLE_SUPERVISEUR','ROLE_DRH','ROLE_CHEFDESERVICE'])},
            ...
            },
            {
                ...
                items: [
                 //   {label: 'Liste Retard Par Service', icon: 'pi pi-fw pi-id-card', routerLink: ['/gestion/absencejournaliere'], roles: this.findRole(['ROLE_SUPERVISEUR'],)},
                    {label: 'Absence par Agent', icon: 'pi pi-fw  pi pi-file', routerLink: ['gestion/ListAgentAbsByMatricule'], roles: this.findRole(['ROLE_DRH','ROLE_CHEFDESERVICE','ROLE_SUPERVISEUR'],)},
